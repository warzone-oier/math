...
那么，令 $\mathrm{E}_xf(x,y)=f(x+1,y),\mathrm{E}_yf(x,y)=f(x,y+1)$，即可得
...
$$\Delta_{x_1}\Delta_{x_2}\cdots\Delta_{x_n}f(x_1,x_2,\cdots,x_n)=(\mathrm{E}_{x_1}-1)(\mathrm{E}_{x_2}-1)\cdots(\mathrm{E}_{x_n}-1)f(x_1,x_2,\cdots,x_n)$$

$$=\sum_{c_1,c_2,\cdots,c_n\in\{0,1\}}(-1)^{n-\sum_{k=1}^nc_k}\mathrm{E}_{x_1}^{c_1}\mathrm{E}_{x_2}^{c_2}\cdots\mathrm{E}_{x_n}^{c_n}f(x_1,x_2,\cdots,x_n)$$

$$=\sum_{c_1,c_2,\cdots,c_n\in\{0,1\}}(-1)^{n-\sum_{k=1}^nc_k}f(x_1+c_1,x_2+c_2,\cdots,x_n+c_n)$$
